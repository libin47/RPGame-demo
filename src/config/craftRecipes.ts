...
const craftWoodenSpear: CraftRecipe = {
  ...
  requirements: { requiredDeviceLevel: 0, attributeRequirements: [], timeMinutes: 10 },
...
const craftStoneKnife: CraftRecipe = {
  ...
  requirements: { requiredDeviceLevel: 0, attributeRequirements: [], timeMinutes: 8 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 10, affectedByCoefficient: true }],
...
const craftFishingRod: CraftRecipe = {
  ...
  requirements: { requiredDeviceLevel: 0, attributeRequirements: [], timeMinutes: 12 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 10, affectedByCoefficient: true }],
...
const craftWoodenPole: CraftRecipe = {
  ...
  requirements: { requiredDeviceLevel: 0, attributeRequirements: [], timeMinutes: 5 },
...
const craftClothScrap: CraftRecipe = {
  ...
  requirements: { requiredDeviceLevel: 0, attributeRequirements: [], timeMinutes: 3 },
