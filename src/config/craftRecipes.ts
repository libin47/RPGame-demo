...
const craftStoneAxe: CraftRecipe = {
  ...
  requirements: { skillRequirements: [], attributeRequirements: [], timeMinutes: 15 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 15, affectedByCoefficient: true }],
  products: [{ itemId: '石斧', baseQuantity: 1 }],
  isRepeatable: true,
  experienceReward: { skillId: 'crafting', expPerCraft: 20, firstTimeBonusExp: 30 },
  minCraftQuantity: 1,
  maxCraftQuantity: 1,
...
const craftWoodenSpear: CraftRecipe = {
  ...
  requirements: { skillRequirements: [], attributeRequirements: [], timeMinutes: 10 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 10, affectedByCoefficient: true }],
  products: [{ itemId: '木矛', baseQuantity: 1 }],
  isRepeatable: true,
  experienceReward: { skillId: 'crafting', expPerCraft: 15, firstTimeBonusExp: 25 },
  minCraftQuantity: 1,
  maxCraftQuantity: 1,
  additionalTimePerItem: 0,
}
...
const craftStoneKnife: CraftRecipe = {
  ...
  requirements: { skillRequirements: [], attributeRequirements: [], timeMinutes: 8 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 10, affectedByCoefficient: true }],
  products: [{ itemId: '石刀', baseQuantity: 1 }],
  isRepeatable: true,
  experienceReward: { skillId: 'crafting', expPerCraft: 12, firstTimeBonusExp: 20 },
  minCraftQuantity: 1,
  maxCraftQuantity: 1,
  additionalTimePerItem: 0,
}
...
const craftFishingRod: CraftRecipe = {
  ...
  requirements: { skillRequirements: [], attributeRequirements: [], timeMinutes: 12 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 10, affectedByCoefficient: true }],
...
const craftWoodenPole: CraftRecipe = {
  ...
  requirements: { skillRequirements: [], attributeRequirements: [], timeMinutes: 5 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 5, affectedByCoefficient: true }],
  products: [{ itemId: '木竿', baseQuantity: 1 }],
  isRepeatable: true,
  experienceReward: { skillId: 'crafting', expPerCraft: 8, firstTimeBonusExp: 15 },
  minCraftQuantity: 1,
  maxCraftQuantity: 1,
  additionalTimePerItem: 0,
}
...
const craftBandage: CraftRecipe = {
  ...
  isRepeatable: true,
  experienceReward: { skillId: 'crafting', expPerCraft: 5, firstTimeBonusExp: 20 },
  minCraftQuantity: 1,
  maxCraftQuantity: 5,
...
const craftClothScrap: CraftRecipe = {
  ...
  requirements: { skillRequirements: [], attributeRequirements: [], timeMinutes: 3 },
  costs: [{ costType: RecipeCostType.STAMINA, value: 3, affectedByCoefficient: true }],
  products: [{ itemId: '布料碎片', baseQuantity: 3 }],
  isRepeatable: true,
  experienceReward: { skillId: 'crafting', expPerCraft: 3, firstTimeBonusExp: 8 },
  minCraftQuantity: 1,
  maxCraftQuantity: 10,
...
const craftIronSheet: CraftRecipe = {
  ...
  isRepeatable: true,
  experienceReward: { skillId: 'crafting', expPerCraft: 5, firstTimeBonusExp: 15 },
  minCraftQuantity: 1,
  maxCraftQuantity: 5,
