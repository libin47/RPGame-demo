...
import { nextFrame, endEvent, switchScene, addItem, setFlag, addDaily } from './shared'
...
export const event_飞机残骸_搜索行李架: GameEvent = {
  ...
  frames: [
    {
      id: 'event_飞机残骸_搜索行李架',
      text: '头顶的行李架里，一只手提箱卡在角落。\n\n你用力拽出来，拉链已经锈住。撬开后里面是换洗衣物和一个洗漱包。洗漱包里有小剪刀、指甲刀、一面巴掌大的镜子。镜子基本完好，只有一道裂纹。\n\n你把镜子用衣服包好，放进外套口袋。把装衣服的防水布也收了起来。',
...
export const event_飞机残骸_搜索幸存者: GameEvent = {
  id: 'event_飞机残骸_搜索幸存者',
  name: '搜索幸存者',
  frames: [
    {
      id: 'event_飞机残骸_搜索幸存者',
      text: '你翻遍了机舱，想要找到一丝幸存者的痕迹。但是——\n\n没有，什么都没有。没有人、甚至或者尸体。他们去哪儿了呢？\n\n残留的片片血迹让你知道飞机失事时机舱里的尖叫与哭声并非梦境，已有些发黑的血迹竟让你有种莫名安心。',
      options: [
        {
          id: '继续',
          name: '继续',
