...
const beach_飞机残骸: SubScene = {
  ...
  descriptions: [
    ...
    },
    {
      id: 'beach_飞机残骸_3',
      priority: 3,
      text: '先把其他旅客的去向抛到脑后吧，你发昏的脑袋已经再难思考分毫。你需要休息。\n\n你透过舷窗望向窗外，半截机翼斜插在沙中，形成了一个天然的遮蔽。\n\n你可以在那里建造一个简单的避难所。\n\n点击【移动】选择【坠机海滩】回到海滩。',
